...
クッキーを所持する持続時間が指定されます。
例として、24時間後と指定すれば、文字通り24時間後にクッキーの所有が破棄されるため、
そのブラウザがもし「サービスへのログイン」をクッキー情報で行っていた場合はログアウトされます。
...
厳しいほどセキュリティレベルは高く、CSRFに備えることができ、また近年はこのセキュリティレベルが全体的に高まっています。
